          ...
          <div className="md:grid md:grid-cols-12 md:gap-6 mt-20">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">{copy.features.features[0].heading}</div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">{copy.features.features[1].heading} </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">{copy.features.features[2].heading}</div>
