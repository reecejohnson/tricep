...
function Process() {
  const {
    customerProcess: { heading, subheading, one, two, three },
  } = copy;
        ...
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:gap-x-6 lg:gap-x-12 md:grid-cols-3 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center">
              ...
              {/* Number */}
              <div className="w-12 h-12 rounded-full bg-teal-400 dark:bg-teal-600 dark:bg-opacity-25 flex justify-center items-center text-white dark:text-teal-400 font-medium">
                1
              </div>
              <p className="mt-4 text-xl font-bold leading-snug tracking-tight mb-1 text-lg text-center">
                {one.title}
              </p>
              <p className="mt-2 mb-8 text-gray-400 tracking-tight mb-1 text-center">
                {one.subtitle}
              </p>
              {/* Mobile mockup */}
            ...
            <div className="relative flex flex-col items-center">
              ...
              <p className="mt-4 text-xl font-bold leading-snug tracking-tight mb-1 text-center">
                {two.title}
              </p>
              <p className="mt-2 mb-8 text-gray-400  tracking-tight mb-1 text-center">
                {two.subtitle}
              ...
              <div className="inline-flex relative justify-center items-center">
                ...
                <img
                  className="absolute"
                  src="/images/mockup-image-03.png"
                  width="290"
                  height="624"
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                ...
                <img
                  className="absolute"
                  src="/images/mockup-image-04.png"
                  width="290"
                  height="624"
                  style={{ maxWidth: '84.33%' }}
                  alt="App screen 04"
