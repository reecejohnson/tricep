          ...
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="md:col-span-5 lg:col-span-5 text-center md:text-right" data-aos="fade-up" data-aos-delay="450">
              <div className="inline-flex relative justify-center items-center">
                ...
                <img className="absolute" src="/images/mockup-image-01.png" width="290" height="624" style={{ maxWidth: '84.33%' }} alt="Features illustration" />
                {/* iPhone mockup */}
                <img className="relative max-w-full mx-auto md:mr-0 md:max-w-none h-auto pointer-events-none" src="/images/iphone-mockup.png" width="344" height="674" alt="iPhone mockup" aria-hidden="true" />
                {/* Play button */}
