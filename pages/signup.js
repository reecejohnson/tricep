            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
              <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                ...
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                  <h1 className="h1 mb-4" data-aos="fade-up">Sign Up</h1>
                ...
                {/*<form className="max-w-xl mx-auto" data-aos="fade-up" data-aos-delay="400">*/}
                  <button type="button" onClick={() => handleStripeConnect()} className="stripe-connect"><span>Connect with</span></button>
                {/*</form>*/}

                <Checkout priceId={"price_1IedZSL4te1d25v7AF8NmM7A"} text="Buy" classNames="bg-teal-500" cancelUrl="/signup" />
