              ...
              <div className="pt-32 pb-12 md:pt-40">
                ...
                <div className="max-w-3xl mx-auto text-center">
                  <h1 className="h1 mb-4" data-aos="fade-up">
                    Apply for a Tricep store
                  </h1>
                  <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">
                    Submit your details to apply for your Tricep store. We will get back to you as
                    soon as possible.
                  </p>
                </div>
                ...
                <section className="relative">
                  <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
                    {submitError === true && (
                      <div className="flex flex-col items-center justify-center py-6 bg-red-300 text-red-900 my-4 max-w-xl mx-auto -mb-6 md:-mb-12">
                            ...
                            >
                              <div className="flex flex-wrap -mx-3 mb-4">
                                <div className="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                  ...
                                  <Field
                                    id="firstName"
                                    name="firstName"
                                    className="form-input w-full text-gray-200"
                              ...
                              <div className="flex flex-wrap -mx-3 mb-4">
                                <div className="w-full px-3">
                                  ...
                                  <Field
                                    ...
                                    className="form-input w-full text-gray-200"
                                    rows="4"
                                    placeholder="Why you want a Tricep store"
                                  />
                              ...
                              <div className="flex flex-wrap -mx-3 mt-6">
                                <div className="w-full px-3">
                                  <button
                                    type="submit"
                                    className="btn text-white bg-teal-500 hover:bg-teal-600 w-full"
                                  >
                                    Send
                                  </button>
                                </div>
